...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  String _activeTab = 'dashboard'; // 'dashboard', 'profile', 'notifications', 'wallet'
  ...
  final List<String> _prizes = ['₹100', '₹250', '₹500', 'Try Again', '₹1000', '₹150'];
  ...
  void _startSpinning() {
    ...
    setState(() {
      ...
      _selectedPrizeIndex = rewardingIndices[math.Random().nextInt(rewardingIndices.length)];
    });
    ...
    final double targetAngle = (2 * math.pi * 6) + (1.5 * math.pi) - ((_selectedPrizeIndex + 0.5) * wedgeAngle);
        ...
        return AlertDialog(
          ...
          actions: [
            ElevatedButton(
              ...
              child: const Text('GREAT, THANK YOU!', style: TextStyle(fontWeight: FontWeight.bold)),
            ),
          ],
        );
      },
  ...
  void _handleNotificationLink(String link) async {
    if (link.startsWith('tel:')) {
      ...
      try {
        ...
        if (!mounted) return;
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Support line: ${link.replaceAll('tel:', '')}')),
        );
      }
    } else if (link.startsWith('/products')) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Redirecting you to the Jewellery Catalog Store! Check the Shop tab below.'),
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Center(
                        child: Icon(Icons.stars_rounded, color: Color(0xFFC5A059), size: 20),
                      ),
                    ),
                  ],
                ),
                ...
                children: [
                  ...
                  if (!_isVerifyingOTP) ...[
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Row(
                          ...
                          children: [
                            ...
                            const Text(
                              "🇮🇳 +91",
                              style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF2C2C2C), fontSize: 13),
                            ),
                      ...
                      validator: (val) {
                        if (val == null || val.trim().length < 10) return 'Enter a valid 10-digit number';
                        return null;
                      },
                    ),
                    const SizedBox(height: 16),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.stars_rounded, color: Color(0xFFC5A059)),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: const BorderSide(color: Color(0xFFC5A059), width: 1.5),
                      ...
                      children: [
                        Row(
                          ...
                          children: List.generate(6, (index) {
                            ...
                            final bool isFocused = _otpController.text.length == index;
                            return Container(
                              width: 36,
                              height: 48,
                              decoration: BoxDecoration(
                      ...
                      children: [
                        TextButton(
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text('New test OTP code sent! Use 123456.'),
                                backgroundColor: Color(0xFFC5A059),
                              ),
                            );
                          },
                          ...
                          child: const Text(
                            'Resend Code',
                            style: TextStyle(color: Color(0xFF707070), fontSize: 11, decoration: TextDecoration.underline),
                          ),
                        ),
                        TextButton(
                          onPressed: () {
                          ...
                          child: const Text(
                            'Change Details',
                            style: TextStyle(color: Color(0xFFC5A059), fontSize: 11, fontWeight: FontWeight.bold),
                          ),
                        ),
                      ],
                    ),
                  ...
                  GestureDetector(
                    onTap: () {
                      if (!_isVerifyingOTP) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('OTP sent to +91! Use testing code: 123456'),
                            backgroundColor: Color(0xFFC5A059),
                          ),
                        );
                      } else {
                        ...
                        if (_otpController.text != '123456') {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Invalid verification code! Try code: 123456 for testing.'),
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          _isVerifyingOTP ? 'VERIFY & REGISTER' : 'SEND OTP & CONTINUE',
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 13,
      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              _buildTabButton('dashboard', Icons.dashboard_rounded, 'Dashboard'),
              _buildTabButton('profile', Icons.person_rounded, 'My Profile'),
              _buildTabButton('notifications', Icons.notifications_rounded, 'Notifications', badgeCount: provider.notificationsList.length),
              _buildTabButton('wallet', Icons.account_balance_wallet_rounded, 'Wallet & Rewards'),
  ...
  Widget _buildTabButton(String id, IconData icon, String title, {int badgeCount = 0}) {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('Are you sure you want to sign out of your premium Arham dashboard?'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    IconButton(
                      icon: const Icon(Icons.copy_rounded, color: Color(0xFFC5A059)),
                      ...
                      onPressed: () {
                        Clipboard.setData(ClipboardData(text: provider.userReferralCode));
                        ScaffoldMessenger.of(context).showSnackBar(
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('INVITE FRIENDS', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFFC5A059),
                    foregroundColor: Colors.white,
          ...
          const Text(
            ...
            style: TextStyle(color: Color(0xFF2C2C2C), fontWeight: FontWeight.bold, fontSize: 13),
          ),
          ...
          GridView.count(
            ...
            children: [
              _buildStatsCard('Total Invites', '${provider.successfulReferrals} friends', Icons.people_alt_rounded, const Color(0x1F2563EB)),
              _buildStatsCard('Total Winnings', '₹${provider.referralEarnings.toStringAsFixed(0)}', Icons.stars_rounded, const Color(0x1F10B981)),
              _buildStatsCard('Program Tier', provider.programTier, Icons.workspace_premium_rounded, const Color(0x1FC5A059)),
              _buildStatsCard('Invite Status', provider.inviteStatus, Icons.check_circle_rounded, const Color(0x1F14B8A6)),
            ],
          ),
          const SizedBox(height: 20),

          // Simulate Referral Input block (Enforces the max 10 invite rules)
          Container(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Simulate a Friend Signup',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Color(0xFF2C2C2C)),
                ),
                const SizedBox(height: 4),
                const Text(
                  'Enter a friend name to simulate referral code registration. Enforces rule of maximum 10 invites!',
                  style: TextStyle(fontSize: 10.5, color: Color(0xFF707070)),
                ),
                const SizedBox(height: 12),
                Row(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        final success = provider.simulateReferralInvite(name);
                        _inviteNameController.clear();

                        if (success) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Successfully simulated! ₹100 credit added for inviting $name.'),
                            ...
                            builder: (context) => AlertDialog(
                              title: const Row(
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text('Rule Cap Reached', style: TextStyle(fontWeight: FontWeight.bold)),
                                ],
                              ),
                              content: const Text(
                                'Invite Blocked! According to Firebase promotions policy, accounts are capped at a maximum of 10 successful monthly referrals.'
                              ),
                              actions: [
                                TextButton(
                                  onPressed: () => Navigator.pop(context),
                                  child: const Text('OK', style: TextStyle(color: Color(0xFFC5A059))),
                                )
                              ],
                            ),
                          );
          ...
          if (provider.referralsHistory.isEmpty) ...[
            const Center(
              child: Padding(
                ...
                child: Text('No referrals yet. Spread invites to earn rewards!', style: TextStyle(fontSize: 12, color: Colors.grey)),
              ),
            ),
          ] else ...[
            ListView.builder(
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      backgroundColor: const Color(0xFFC5A059).withValues(alpha: 0.15),
                      child: Text(
                        referral['avatar'] ?? 'U',
                    ...
                    subtitle: Text(
                      ...
                      style: const TextStyle(fontSize: 10.5, color: Color(0xFF707070)),
                    ),
                    trailing: Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.gavel_rounded, color: Color(0xFFC5A059), size: 18),
              const SizedBox(width: 8),
              const Text(
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.history_toggle_off_rounded, color: Color(0xFFC5A059), size: 18),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.wallet_giftcard_rounded, color: Color(0xFFC5A059), size: 18),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(label, style: const TextStyle(color: Color(0xFF707070), fontSize: 10.5, fontWeight: FontWeight.w500)),
              Container(
          ...
          Text(
            value,
            style: const TextStyle(color: Color(0xFF2C2C2C), fontWeight: FontWeight.bold, fontSize: 14),
          ),
        ],
      ),
    );
        ...
        children: [
          ...
          if (provider.hasSpunWheel) ...[
            Container(
              ...
              child: Column(
                children: [
                  const Icon(Icons.check_circle_outline_rounded, color: Color(0xFFC5A059), size: 36),
                  const SizedBox(height: 8),
                  const Text('Spin Claimed Successfully!', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                  const SizedBox(height: 4),
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: const TextStyle(color: Color(0xFF707070), fontSize: 10.5),
                  ),
                ],
              ),
            ),
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: Color(0xFFC5A059)),
                      ),
                    ),
                  ),
                ),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Text('Edit Profile', style: TextStyle(fontSize: 11, color: Color(0xFF707070))),
                    Switch.adaptive(
            ...
            // Form inputs
            _buildProfileField('Full Name', _profileNameController, Icons.person_rounded),
            _buildProfileField('Email Address', _profileEmailController, Icons.email_rounded),
            _buildProfileField('Phone Number', _profilePhoneController, Icons.phone_rounded),
            _buildProfileField('Street Address', _profileAddressController, Icons.home_rounded),
            _buildProfileField('City', _profileCityController, Icons.location_city_rounded),
            _buildProfileField('Pin Code', _profileZipController, Icons.pin_drop_rounded),
            const SizedBox(height: 20),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        provider.userReferralCode,
                        style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 1.5, color: Color(0xFF2C2C2C)),
                      ),
                      Row(
                        children: [
                          IconButton(
                            icon: const Icon(Icons.copy, size: 18, color: Color(0xFFC5A059)),
                            onPressed: () {
                              Clipboard.setData(ClipboardData(text: provider.userReferralCode));
                              ScaffoldMessenger.of(context).showSnackBar(
                          ...
                          IconButton(
                            icon: const Icon(Icons.share_rounded, size: 18, color: Color(0xFFC5A059)),
                            onPressed: () {
                              Share.share(
                                "Join Arham Ornaments today and get ₹100 instant credits! ✨\n\nUse my referral code: ${provider.userReferralCode}\n\nSign up here: https://www.arhamornaments.com/?ref=${provider.userReferralCode}",
                                subject: "Arham Ornaments Invitation",
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(provider.userName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13.5)),
                      Text(provider.userEmail, style: const TextStyle(color: Colors.grey, fontSize: 10.5)),
                    ],
                  ),
                ),
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFFC5A059), width: 0.6),
                  ),
                  child: Text(
                    '₹${provider.walletBalance.toStringAsFixed(0)}',
                    style: const TextStyle(color: Color(0xFFC5A059), fontWeight: FontWeight.bold, fontSize: 11),
                  ),
                ),
              ],
            ),
          ...
          if (provider.notificationsList.isEmpty) ...[
            const Center(
              child: Padding(
                ...
                child: Text('No active notifications at this moment.', style: TextStyle(fontSize: 12, color: Colors.grey)),
              ),
            ),
          ] else ...[
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(14),
                    side: BorderSide(color: isUnread ? const Color(0x6BC5A059) : const Color(0x12C5A059)),
                  ),
                  margin: const EdgeInsets.only(bottom: 10),
                  child: Container(
                    decoration: BoxDecoration(
                      border: isUnread ? const Border(left: BorderSide(color: Color(0xFFC5A059), width: 3.5)) : null,
                    ),
                    child: Padding(
                      padding: const EdgeInsets.all(16.0),
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: const TextStyle(fontSize: 11.5, color: Color(0xFF555555), height: 1.4),
                          ),
                          if (notification['link'] != null) ...[
                            const SizedBox(height: 10),
                            TextButton.icon(
                              onPressed: () {
                                _handleNotificationLink(notification['link']);
                              },
                              icon: const Icon(Icons.open_in_new_rounded, size: 14, color: Color(0xFFC5A059)),
                              label: const Text(
                                'VISIT LINK NOW',
                                style: TextStyle(color: Color(0xFFC5A059), fontSize: 11, fontWeight: FontWeight.bold),
                              ),
        ...
        children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(provider.userName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                      Text('${provider.successfulReferrals} active referrals', style: const TextStyle(color: Colors.grey, fontSize: 10)),
                    ],
                  ),
                ),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                  decoration: BoxDecoration(color: const Color(0xFFFCFAF6), borderRadius: BorderRadius.circular(12)),
                  child: const Text('Tier: Elite', style: TextStyle(color: Color(0xFFC5A059), fontWeight: FontWeight.bold, fontSize: 9.5)),
                )
              ],
            ),
          ),
          ...
          LayoutBuilder(
            builder: (context, constraints) {
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: const [BoxShadow(color: Color(0x1AE68A00), blurRadius: 6, offset: Offset(0, 3))],
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(16),
                      boxShadow: const [BoxShadow(color: Color(0x1A1B8A5A), blurRadius: 6, offset: Offset(0, 3))],
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
              ...
              if (isWide) {
                ...
                return Column(children: cards.map((c) => c is Expanded ? c.child : c).toList());
              }
            },
          ),
          const SizedBox(height: 24),
          ...
          if (provider.transactionsHistory.isEmpty) ...[
            const Center(
              child: Padding(
                padding: EdgeInsets.all(16.0),
                child: Text('No transaction logs yet.', style: TextStyle(fontSize: 12, color: Colors.grey)),
              ),
            ),
          ] else ...[
            ListView.builder(
