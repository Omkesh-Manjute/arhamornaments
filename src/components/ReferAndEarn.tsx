...
const ReferAndEarn: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8">
          <div className="inline-flex p-4 bg-orange-100 rounded-2xl mb-4">
            <Gift className="w-10 h-10 text-orange-600 animate-bounce" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-50 transition-all">
              ...
              <div className="flex gap-2">
                <div className="flex-1 bg-gray-50 p-4 rounded-xl font-mono text-2xl font-bold text-gray-800 tracking-widest border-2 border-dashed border-orange-200">
                  {user.referralCode}
                </div>
                <button 
                  onClick={copyCode}
                  className="bg-orange-600 hover:bg-orange-700 text-white p-4 rounded-xl transition-colors shadow-lg shadow-orange-200 active:scale-95"
                >
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-50 transition-all">
              ...
              <button 
                onClick={shareCode}
                className="w-full h-full bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-700 hover:to-yellow-700 text-white font-bold py-4 px-6 rounded-xl shadow-xl shadow-orange-200 transition-all flex items-center justify-center gap-3 active:scale-95"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
            <div className="p-6 bg-orange-50 rounded-2xl text-center border border-orange-100">
              ...
              <div className="text-2xl font-bold text-gray-800">{user.referralCount || 0}</div>
              <div className="text-sm text-gray-500">Friends Joined</div>
            </div>
            <div className="p-6 bg-green-50 rounded-2xl text-center border border-green-100">
              ...
              <div className="text-2xl font-bold text-gray-800">₹{(user.referralCount || 0) * 100}</div>
      ...
      <div className="mt-12 bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 font-heading">How it works</h2>
        <div className="space-y-6">
          <div className="flex gap-4">
            <div className="w-10 h-10 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center font-bold flex-shrink-0">1</div>
            <div>
              <h3 className="font-bold text-gray-800">Share your code</h3>
              <p className="text-gray-600">Send your unique referral code or link to your friends and family.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-10 h-10 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center font-bold flex-shrink-0">2</div>
            <div>
              <h3 className="font-bold text-gray-800">They Sign Up</h3>
              <p className="text-gray-600">When they create an account using your code, they immediately get ₹100 bonus.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-10 h-10 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center font-bold flex-shrink-0">3</div>
            <div>
              <h3 className="font-bold text-gray-800">Get Rewarded</h3>
              <p className="text-gray-600">You'll also receive ₹100 in your wallet for every successful referral!</p>
            </div>
          </div>
        </div>
      </div>
